...
const ContactForm = () => {
  ...
  const validationSchema = Yup.object().shape({
    name: Yup.string()
      .matches(
        /^[a-zA-Z0-9À-ÿ\s'-]*$/,
        "Le nom ne doit contenir que des lettres, des chiffres, des espaces et des caractères spécifiques"
      )
      .required("Le nom est requis"),
    surname: Yup.string()
      .matches(
        /^[a-zA-Z0-9À-ÿ\s'-]*$/,
        "Le prénom ne doit contenir que des lettres, des chiffres, des espaces et des caractères spécifiques"
      )
      ...
      <Form>
        <div className="contain my-12 font-assistantRegular flex flex-col mx-8 px-3 pt-6  md:mx-16 lg:my-0 lg:grid lg:grid-cols-2 lg:mx-96 lg:mb-20 hover:scale-100 hover:ease-in-out hover:duration-200 lg:hover:scale-105">
          ...
          <div className="flex flex-row justify-center py-8 lg:col-span-2 lg:py-8 lg:pb-10">
            <label htmlFor="acceptCGU" className="flex-row">
              <Field
                type="checkbox"
                id="acceptCGU"
                name="acceptCGU"
