...
const Form = () => {
  return (
    <form>
      <div className="px-3 flex flex-col pt-6 lg:grid grid-cols-2 lg:items-center">
        <div className="flex flex-col items-center">
          <label htmlFor="">Votre nom :</label>
          <Input type="text" className="md:w-96" />
        </div>
      ...
      <div className="flex flex-col items-center lg:justify-center md:px-48 lg:px-80">
        ...
        <textarea
          ...
          cols="30"
          rows="10"
          className="rounded-lg bg-cyan-800 hover:bg-white hover:text-black md:w-full lg:w-full "
        ></textarea>
      </div>
