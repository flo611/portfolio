    ...
    <form className="contain my-12 lg:my-0 flex flex-col mx-8 px-3 pt-6 lg:grid lg:grid-cols-2 lg:mx-96 lg:mb-20 hover:scale-100 hover:ease-in-out hover:duration-200 lg:hover:scale-105">
      ...
      <div className="mx-8 flex flex-col items-center lg:justify-center lg:col-span-2 lg:py-4">
        ...
        <textarea
          ...
          // cols="50"
          // rows="10"
          className="h-40 lg:w-10/12 lg:h-72 rounded-lg bg-cyan-800 hover:bg-white text-black border border-blue-300 focus-visible:border-blue-300 focus:border-blue-300 hover:transition hover:ease-in-out hover:duration-200"
        ></textarea>
      </div>
