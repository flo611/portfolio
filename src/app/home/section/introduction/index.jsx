    ...
    >
      <div className="mt-28 lg:mt-72">
        <div className="flex flex-col">
          ...
          <p className="text-white pb-24 mx-7 text-xs  md:mx-24 md:text-center md:text-base lg:text-center lg:text-2xl lg:pt-20">
          ...
          <div className="flex flex-row justify-center pt-16 pb-26 lg:pb-40">
